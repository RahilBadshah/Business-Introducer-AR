...
namespace Google.XR.ARCoreExtensions.Samples.Geospatial
{
    ...
    public class GeospatialController : MonoBehaviour
    {
        ...
        public GameObject XbotPrefab, YbotPrefab, WrestlerPrefab, DoctorPrefab, MealPrefab;
        ...
        private IEnumerator _startDistanceCalculationService = null;
        private IEnumerator _asyncCheck = null;
        public static GeospatialController instance;
        ...
        public void OnDisable()
        {
            ...
            StopCoroutine(_startDistanceCalculationService);
            _startDistanceCalculationService = null;
        ...
        public void Update()
        {
            ...
            {
                _startDistanceCalculationService = LocationManager.instance.GetDistanceCalculationStarted();
                StartCoroutine(_startDistanceCalculationService);
                ...
                Debug.Log("Out of foreach Line 548");
        ...
        public void AddLocation(double lat, double lon, int type)
        {
            GeospatialAnchorHistory history;

            history = new GeospatialAnchorHistory(
                lat, lon, 0,
                Quaternion.identity);
            var anchor = PlaceGeospatialAnchor(history, _usingTerrainAnchor, type);
            if (anchor != null)
            {
                _historyCollection.Collection.Add(history);
        ...
        private void PlaceAnchorByScreenTap(Vector2 position)
        {
            ...
            //     history = new GeospatialAnchorHistory(
            //         23.052250573803207, 72.53414838807852, 0,
            //         geospatialPose.EunRotation);
            //     var anchor = PlaceGeospatialAnchor(history, _usingTerrainAnchor);
            //     if (anchor != null)
            //     {
            ...
            //     history = new GeospatialAnchorHistory(
            //         23.052305588909864, 72.53418786915556, 0,
            //         geospatialPose.EunRotation);
            //     anchor = PlaceGeospatialAnchor(history, _usingTerrainAnchor);
            //     if (anchor != null)
            //     {
            //         _historyCollection.Collection.Add(history);
            //         Debug.Log("Anchor Placed");
            ...
            //     history = new GeospatialAnchorHistory(
            //                         23.052058023119717, 72.53910715476368, 0,
            //                         geospatialPose.EunRotation);
            //     anchor = PlaceGeospatialAnchor(history, _usingTerrainAnchor);
            //     if (anchor != null)
            //     {
            ...
            //     history = new GeospatialAnchorHistory(
            //         23.052272325653213, 72.53415919834089, 10,
            //         geospatialPose.EunRotation);
            //     anchor = PlaceGeospatialAnchor(history, _usingTerrainAnchor);
            //     if (anchor != null)
            //     {
            ...
            //     // Chandlodia
            //     history = new GeospatialAnchorHistory(
            //         23.02684993139946, 72.58578955339381, 0,
            //         geospatialPose.EunRotation);
            //     anchor = PlaceGeospatialAnchor(history, _usingTerrainAnchor);
            //     if (anchor != null)
            //     {
            ...
            //     history = new GeospatialAnchorHistory(
            //         23.071259195419305, 72.5183810274484, 10,
            //         geospatialPose.EunRotation);
            //     anchor = PlaceGeospatialAnchor(history, _usingTerrainAnchor);
            //     if (anchor != null)
            //     {
            ...
            //     history = new GeospatialAnchorHistory(
            //         23.071320270462827, 72.5181228647703, 10,
            //         geospatialPose.EunRotation);
            //     anchor = PlaceGeospatialAnchor(history, _usingTerrainAnchor);
            //     if (anchor != null)
            //     {
            ...
            //     history = new GeospatialAnchorHistory(
            //         23.071273342236925, 72.5183696173558, 10,
            //         geospatialPose.EunRotation);
            //     anchor = PlaceGeospatialAnchor(history, _usingTerrainAnchor);
            //     if (anchor != null)
            //     {
            ...
            //     history = new GeospatialAnchorHistory(
            //         23.052278482256813, 72.53416097727315, 10,
            //         geospatialPose.EunRotation);
            //     anchor = PlaceGeospatialAnchor(history, _usingTerrainAnchor);
            //     if (anchor != null)
            //     {
        ...
        private ARGeospatialAnchor PlaceGeospatialAnchor(
            GeospatialAnchorHistory history, bool terrain = false, int type = 0)
        {
            ...
            if (eunRotation == Quaternion.identity)
            {
                ...
                eunRotation =
                    Quaternion.AngleAxis((float)history.Heading, Vector3.up);
            }
            ...
            if (anchor != null)
            {
                ...
                switch (type)
                {
                    case 0:
                        Debug.Log("CASE 0");
                        anchorGO = terrain ?
                                Instantiate(XbotPrefab, anchor.transform) :
                                Instantiate(XbotPrefab, anchor.transform);
                        break;
                    case 1:
                        Debug.Log("CASE 1");
                        anchorGO = terrain ?
                                    Instantiate(MealPrefab, anchor.transform) :
                                    Instantiate(MealPrefab, anchor.transform);
                        break;
                    case 2:
                        Debug.Log("CASE 2");
                        anchorGO = terrain ?
                                    Instantiate(WrestlerPrefab, anchor.transform) :
                                    Instantiate(WrestlerPrefab, anchor.transform);
                        break;
                    case 3:
                        Debug.Log("CASE 3");
                        anchorGO = terrain ?
                                    Instantiate(DoctorPrefab, anchor.transform) :
                                    Instantiate(DoctorPrefab, anchor.transform);
                        break;
                    default:
